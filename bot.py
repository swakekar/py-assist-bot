...
def wishMe():
    ...
    weather()
    speak('I am Your Bot. Please may I help you !!')
...
if __name__ == '__main__':
    ...
    while True:
        ...
        elif 'youtube downloader'.lower() in query:
            exec(open('youtube_downloader.py').read())

        elif 'voice'.lower() in query:
            if 'female'.lower() in query:
                engine.setProperty('voice', voices[1].id)
            else:
        ...
        if 'jarvis are you there' in query:
            ...
            if platform == "win32" or "darwin":
                speak('Satyam is my master. He created me couple of days ago')
